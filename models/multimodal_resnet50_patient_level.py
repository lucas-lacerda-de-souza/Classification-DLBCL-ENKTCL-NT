"""
Multimodal ResNet50 Classifier for DLBCL and ENKTCL-NT
-------------------------------------------------------------------------------------------
...
Description:
    ...
    to classify lymphoid lesions into Diffuse Large B-Cell Lymphoma (DLBCL – Class 1)
    and Extranodal NK/T-Cell Lymphoma, nasal-type (ENKTCL-NT – Class 2).

    The model uses ResNet50 for feature extraction from image patches, combines it with
